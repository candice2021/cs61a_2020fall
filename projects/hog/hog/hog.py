...
def roll_dice(num_rolls, dice=six_sided):
    ...
    total_score_turn = 0
    temp_score_one = 0
    temp_score_not_one = 0
    num = 1
    while num <= num_rolls:
        num_every_turn = dice()
        num += 1
        if num_every_turn != 1:
            temp_score_not_one += num_every_turn
        else:
            temp_score_one = 1
    ...
    if temp_score_one == 1:
        ...
        total_score_turn += temp_score_not_one
    
    return total_score_turn
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    small_range = pow(10, score)
    large_range = pow(10, score + 1)
    while not (small_range < pi < large_range): 
        pi = pi // 10
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls !=0 :
        #notice that pass the dice argument into roll_dice()
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def commentary(score0, score1):
        ...
        if who == 0:
            increase0 = score0 - last_score
            if increase0 > running_high:
                print('{0} point(s)! The most yet for Player {1}'.format(increase0, who))
            ...
            increase1 = score1 - last_score 
            if increase1 > running_high: 
                print('{0} point(s)! The most yet for Player {1}'.format(increase1, who))
                running_highest = increase1
            else:
                running_highest = running_high 
            return announce_highest(who, score1, running_highest)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    score += free_score
    extra_turn_result = extra_turn(score, opponent_score)
    bacon_result = bacon_strategy(score, opponent_score, cutoff, num_rolls)
    if extra_turn_result or bacon_result == 0 :
        return 0
    else:
        return num_rolls
